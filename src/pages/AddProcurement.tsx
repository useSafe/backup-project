        ...
        <div className="space-y-6 pb-20 fade-in animate-in duration-500">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div className="flex flex-wrap items-center gap-3">
                    ...
                    <div className="flex bg-background p-1 rounded-lg border border-slate-700">
                        <button
                            onClick={() => setFormMode('SVP')}
                            className={`px-4 py-2 rounded-md text-sm font-medium transition-all ${formMode === 'SVP' ? 'bg-blue-600 text-foreground shadow-lg' : 'text-slate-400 hover:text-foreground'}`}
                        >
                            SVP
                        </button>
                        <button
                            onClick={() => setFormMode('Shopping')}
                            className={`px-4 py-2 rounded-md text-sm font-medium transition-all ${formMode === 'Shopping' ? 'bg-amber-600 text-foreground shadow-lg' : 'text-slate-400 hover:text-foreground'}`}
                        >
                            Shopping
                        </button>
                        <button
                            onClick={() => setFormMode('Regular')}
                            className={`px-4 py-2 rounded-md text-sm font-medium transition-all ${formMode === 'Regular' ? 'bg-purple-600 text-foreground shadow-lg' : 'text-slate-400 hover:text-foreground'}`}
                        >
                            Regular Bidding
                        </button>
                    </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <CardContent className="p-6 space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    className="bg-background border-slate-700 text-foreground"
                                />
                            </div>

                            {/* PR Number Construction */}
                            <div className="p-4 rounded-lg bg-background/50 border border-slate-700/50 space-y-4">
                                <div className="flex items-center justify-between gap-2 flex-wrap">
                                    <Label className="text-foreground">PR Number Construction</Label>
                                    {/* Format Toggle */}
                                    <div className="flex bg-card p-0.5 rounded-lg border border-slate-700 text-xs">
                                        <button
                                            type="button"
                                            onClick={() => setPrFormat('old')}
                                            className={`px-3 py-1 rounded-md font-medium transition-all ${prFormat === 'old' ? 'bg-blue-600 text-foreground shadow-sm' : 'text-slate-400 hover:text-slate-200'
                                                }`}
                                        >
                                            Old (Div-Mon-Yr-#)
                                        </button>
                                        <button
                                            ...
                                            className={`px-3 py-1 rounded-md font-medium transition-all ${prFormat === 'new' ? 'bg-purple-600 text-foreground shadow-sm' : 'text-slate-400 hover:text-slate-200'
                                                }`}
                                        >
                                            New (Yr-Mon-#)
                                        </button>
                                ...
                                <div className={`grid gap-4 items-end ${prFormat === 'old' ? 'md:grid-cols-4' : 'md:grid-cols-3'}`}>
                                    ...
                                    {prFormat === 'old' && (
                                        <div className="space-y-2">
                                            ...
                                            <Select value={prDivisionId} onValueChange={setPrDivisionId}>
                                                <SelectTrigger className="bg-background border-slate-700 text-foreground">
                                                    <SelectValue placeholder="Select Division" />
                                                </SelectTrigger>
                                                <SelectContent className="bg-background border-slate-700 text-foreground">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Select value={prMonth} onValueChange={setPrMonth}>
                                            ...
                                            <SelectContent className="bg-background border-slate-700 text-foreground max-h-[200px]">
                                                {MONTHS.map(m => (
                            ...
                            <div className="grid gap-6 md:grid-cols-2">
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        className="bg-background border-slate-700 text-foreground font-mono"
                                    />
                                    <p className="text-xs text-slate-500">Amount in Philippine Pesos (commas added automatically)</p>
                                </div>

                                <div className="space-y-2">
                                    <Label className="text-foreground">Bid Amount (Contract Price) <span className="text-slate-500 text-xs">(Optional)</span></Label>
                                    <Input
                                        type="text"
                            ...
                            <div className="pt-4 border-t border-border space-y-4">
                                ...
                                <div className="grid gap-6 md:grid-cols-2 mt-2">
                                    <div className="space-y-2">
                                        <Label className="text-foreground">Supplier / Awarded To <span className="text-slate-500 text-xs">(Optional)</span></Label>
                            ...
                            <div className="space-y-2 pt-4 border-t border-border">
                                <Label className="text-foreground">Remarks <span className="text-slate-500 text-xs">(Optional)</span></Label>
                                <Textarea
                                    value={description}
                                    onChange={(e) => setDescription(e.target.value)}
                                    placeholder="Enter any additional remarks or notes..."
                                    className="bg-background border-slate-700 text-foreground min-h-[80px] resize-y"
                                    rows={3}
                                />
                            </div>
                            ...
                            <div className="grid gap-6 md:grid-cols-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        className="bg-background border-slate-700 text-foreground [color-scheme:dark]"
                                    />
                                </div>
                            </div>
                ...
                <div className={activeTab !== 'documents' ? 'hidden' : ''}>
                            ...
                            <div className="flex justify-between items-center border-b border-border pb-2">
                                ...
                                <div className="flex gap-2">
                                    <Button
                                        ...
                                        variant="outline"
                                        size="sm"
                                        className="text-xs h-7 bg-slate-800 border-slate-700 text-foreground hover:text-foreground hover:bg-slate-700"
                                        onClick={() => {
                    ...
                    <div className="flex justify-between mt-4">
                        <Button type="button" variant="outline" onClick={() => setActiveTab('monitoring')} className="border-slate-700 text-foreground hover:bg-slate-800 px-8">
                ...
                <div className={activeTab !== 'monitoring' ? 'hidden' : ''} id="tab-monitoring">
                    ...
                    <div className="flex justify-between mt-4">
                        <Button type="button" variant="outline" onClick={() => setActiveTab('basic')} className="border-slate-700 text-foreground hover:bg-slate-800 px-8">
                ...
                <div className={activeTab !== 'storage' ? 'hidden' : ''}>
                        ...
                        <CardContent className="p-6 space-y-6">
                            ...
                            <div className="border border-slate-700 p-4 rounded-xl bg-slate-800/20 space-y-4 mb-6">
                                ...
                                <Select value={storageStatus} onValueChange={(val: any) => setStorageStatus(val)}>
                                    <SelectTrigger className="bg-background border-slate-700 text-foreground w-full max-w-sm">
                                        <SelectValue />
                                    </SelectTrigger>
                                    <SelectContent className="bg-background border-slate-700 text-foreground">
                            ...
                            {storageStatus === 'In Storage' && (
                                <div className="grid gap-6 border-t border-border pt-6">
                                    <div className="flex bg-background p-1 rounded-lg border border-slate-700 self-start">
                                        <button
                                            type="button"
                                            onClick={() => setStorageMode('shelf')}
                                            className={`px-4 py-1.5 rounded-md text-sm font-medium transition-all flex items-center gap-2 ${storageMode === 'shelf' ? 'bg-blue-600 text-foreground shadow-sm' : 'text-slate-400 hover:text-foreground hover:bg-slate-800'}`}
                                        >
                                        ...
                                        <button
                                            ...
                                            className={`px-4 py-1.5 rounded-md text-sm font-medium transition-all flex items-center gap-2 ${storageMode === 'box' ? 'bg-blue-600 text-foreground shadow-sm' : 'text-slate-400 hover:text-foreground hover:bg-slate-800'}`}
                                        >
                                    ...
                                    {storageMode === 'box' && (
                                        <div className="space-y-2 animate-in fade-in zoom-in-95 duration-200">
                                            <Label className="text-foreground">Box</Label>
                                    ...
                                    <div className="space-y-2 animate-in fade-in zoom-in-95 duration-200">
                                        ...
                                        <Select value={folderId} onValueChange={setFolderId} disabled={(storageMode === 'box' ? !boxId : !shelfId) || isFoldersLoading}>
                                            <SelectTrigger className="bg-background border-slate-700 text-foreground flex-1">
                                        ...
                                        <div className="p-4 rounded-lg bg-slate-800/50 border border-slate-700 space-y-4">
                                            ...
                                            <div className="grid grid-cols-2 gap-4">
                                                <div>
                                                    ...
                                                    <Input value={newFolderName} onChange={(e) => setNewFolderName(e.target.value)} className="h-8 bg-background border-slate-600" placeholder="Folder Name" />
                                                </div>
                                                <div>
                                                    <Label className="text-xs text-slate-400">Code</Label>
                                                    <Input value={newFolderCode} onChange={(e) => setNewFolderCode(e.target.value)} className="h-8 bg-background border-slate-600" placeholder="e.g. F1" />
                                                </div>
                                            </div>
                                                ...
                                                <div className="mt-6 p-4 rounded-lg bg-amber-900/20 border border-amber-700/50 space-y-4">
                                                    ...
                                                    <div className="grid gap-4 md:grid-cols-2">
                                                        <div className="space-y-2">
                                                            ...
                                                            <Input value={borrowerName} onChange={(e) => setBorrowerName(e.target.value)} placeholder="Enter borrower's name..." className="bg-background border-slate-700 text-foreground" />
                                                        </div>
                                                        <div className="space-y-2">
                    ...
                    <div className="flex justify-between mt-4">
                        <Button type="button" variant="outline" onClick={() => setActiveTab('documents')} className="border-slate-700 text-foreground hover:bg-slate-800 px-8">
...
const MonitoringDateField = ({ label, value, setValue, isDisabled = false, activeColor = 'blue' }: any) => {
    ...
    return (
        <div className={`space-y-2 p-3 rounded-lg border transition-all ${isDisabled ? 'border-border bg-slate-900/30 opacity-50' : value ? `${activeClasses.border} ${activeClasses.bg}` : 'border-slate-700 bg-slate-800/30'}`}>
            <div className="flex items-center gap-2">
                <Checkbox
                    checked={!!value}
            ...
            <div className="pl-6">
                <input
                    ...
                    disabled={isDisabled}
                    className={`h-8 px-2 rounded-md bg-card border border-slate-700 text-foreground text-xs w-full outline-none ${activeClasses.ring} ${isDisabled ? 'cursor-not-allowed opacity-50' : ''}`}
                />
            </div>
        </div>
    );
    ...
    <div className="flex flex-col space-y-1">
        ...
        <Popover>
            <PopoverTrigger asChild>
                <Button
                    variant="outline"
                    className={`h-9 w-full justify-between text-left font-normal bg-background border-slate-700 text-foreground hover:bg-[#253045] ${!date && "text-muted-foreground"}`}
                >
                    <span>{date ? format(date, 'MMM d, yyyy') : "Pick date"}</span>
                    <CalendarIcon className="ml-2 h-4 w-4 text-foreground opacity-100" />
                </Button>
            </PopoverTrigger>
            <PopoverContent className="w-auto p-0 bg-background border-slate-700">
                <Calendar
                    mode="single"
                    selected={date}
                    onSelect={setDate}
